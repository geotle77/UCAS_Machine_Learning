        ...
        for epoch in range(1, self.hp.num_epochs + 1):
            ...
            if self.mosi_test_loader != None and self.mosei_test_loader != None and self.meld_test_loader != None and self.iemocap_test_loader != None:
                ...
                if self.hp.dataset == 'moseldmp':
                    ...
                    mosei_test_loss, mosei_results, mosei_truths, mosei_ids_list = evaluate(model,
                                                                                            self.mosei_test_loader,
                                                                                            self.hp.n_mosei_test,
                                                                                            test=True)
                    ...
                    iemocap_test_loss, iemocap_results, iemocap_truths, iemocap_ids_list = evaluate(model,
                                                                                                    self.iemocap_test_loader,
                                                                                                    self.hp.n_iemocap_test,
                                                                                                    test=True)
